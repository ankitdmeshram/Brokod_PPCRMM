...
export default function AllProjectsCalendarMain({
  workspace = null,
    ...
    const loadCalendarTasks = async () => {
      ...
      try {
        ...
        await showErrorAlert(
          ...
          error.message || "Something went wrong while loading the workspace calendar."
        );
      } finally {
        setIsLoading(false);
      }
  ...
  }, [authSession?.token, gridEndKey, gridStartKey, workspace?.id]);
        ...
        >
          <Stack spacing={0.5}>
            ...
            <Typography level="body-sm" sx={{ color: "#5c6d90", fontSize: "0.82rem" }}>
              Tasks due this month across every project in {workspaceTitle}.
            </Typography>
          </Stack>
              ...
              {openDayTasks.map((task) => (
                ...
                >
                  <Stack spacing={0.4}>
                    ...
                    <Typography level="body-xs" sx={{ color: "#8b96b3" }}>
